...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
            <a class="navbar-brand" href="#">Trường cao đẳng Công Nghệ Bách Khoa Hà Nôi</a>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card rounded-0 shadow-sm" >
                        <div class="card-header">
                            <span class="text-success"> Ðăng ký</span>
                        </div>
                        <div class="card-body">
                            <form>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="inputAddress" class="col-sm-2 col-form-label">Ðịa chỉ</label>
                                    <div class="col-sm-10">
