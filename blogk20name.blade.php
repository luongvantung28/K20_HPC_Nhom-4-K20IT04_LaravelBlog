...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
            <a class="navbar-brand" href="#">Trường Cao đẳng Công Nghệ Bách Khoa Hà Nội</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/laravel/example-app/resources/views/blogk20gioithieu.blade.php">Giới thiệu về trường học</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="/laravel/example-app/resources/views/blogk20dangnhap.blade.php">Ðăng nhập</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/laravel/example-app/resources/views/blogk20dangki.blade.php">Ðăng ký</a>
                    </li>
                </ul>
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    <div class="card rounded-0 shadow-sm" >
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <h2 class="card-title">Nam 2021: Chào đón HPC – Cơ sở Thanh Trì</h2>
                    ...
                    <div class="card rounded-0 shadow-sm" >
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <h2 class="card-title">Nam 2021: Chào dón HPC – Co sở Thanh Trì</h2>
                   ...
                   <!-- third post  -->
                    ...
                    <div class="card rounded-0 shadow-sm" >
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <h2 class="card-title">Nam 2021: Chào dón HPC – Cơ sở Thanh Trì</h2>
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est consequatur aliquam, non eius aut natus at consequuntur quasi sed corporis possimus adipisci dignissimos atque praesentium sint autem pariatur asperiores laudantium.</p>
                            <a href="blog-post.html" class="btn btn-primary">Read more</a>
                        </div>
                    </div>
